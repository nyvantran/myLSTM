...
class TrainConfig:
    ...
    sample_interval: float = 0.5  # Khoảng thời g
    ...
    num_workers: int = 4  # Số lượng worker (0 là tối ưu nhất khi tensor đã nạp sẵn vào RAM)
    ...
    chunk_size: int = 16  # Kích thước chunk chia nhỏ khung hình khi trích xuất qua CNN chống tràn VRAM
